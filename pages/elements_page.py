...
class TextBoxPage(BasePage):
    ...
    def check_fields_form(self):
        ...
        email = self.element_is_present(self.locators.CREATED_EMAI).text.split(":")[1]
...
class WebTablePage(BasePage):
    ...
    def check_new_added_person(self):
        people_lsit = self.elements_are_present(self.locators.FULL_PEOPLE_LIST)
        data = []
        for item in people_lsit:
...
class UploadAndDownloadPage(BasePage):
    ...
    def download_file(self):
        ...
        path_name_file = rf'C:\Users\User\PycharmProjects\auto_qa\filetest{random.randint(0,999)}.jpg'
...
class DynamicPropertiesPage(BasePage):
    ...
    def check_enable_button(self):
        try:
            enable_button = self.element_is_clickable_visible(self.locators.ENABLE_BUTTON)
